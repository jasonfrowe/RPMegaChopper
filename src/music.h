 ...
 */
extern void start_music(const Note* melody, const Note* bass, const Note* kick, const Note* hihat);

/**
 * Start playing the title screen music
 * Music will loop continuously
 */
extern void start_title_music(void);

/**
 * Start playing the gameplay music (bass only)
 * Music will loop continuously
 */
extern void start_gameplay_music(void);
